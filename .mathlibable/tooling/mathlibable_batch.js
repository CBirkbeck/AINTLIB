...
// args = { project, refs, batch: [ {base, qual, file, line, kind}, ... ] }
...
1. Write the skill's full Phase-8 report to:
   ${report}
   The H1 title MUST contain the qualified name in backticks (e.g. \`# /mathlibable report — \\\`${d.qual}\\\`\`), and the report MUST state the final five-bucket verdict.
