...
field and $`L/K` an algebraic extension whose norm extends that of $`K`. Then
...
closure $`\overline{\mathbb{Q}_p}` is algebraically closed by construction; mathlib shows its
