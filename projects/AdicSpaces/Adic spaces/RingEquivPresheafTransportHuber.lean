...
/-- The composite localization map `Loc D.s → Loc D₁.s → Loc D₁₂.s`, postcomposed with
`coeRingHom`, is `restrictionMapAlg` after the `e₁.trans e₂` localization map: both carry
`algebraMap a` to `D₁₂.canonicalMap ((e₁.trans e₂) a)`. This is the whole content of the
composite law; the parent only transports it to `presheafValue` by density. -/
private theorem locMapOfHom_comp_eq_restrictionMapAlg_comp
    ...
    (hs₁ : (D.mapHuber e₁ he₁ he₁').s = e₁.toRingHom D.s)
    (hs₂ : ((D.mapHuber e₁ he₁ he₁').mapHuber e₂ he₂ he₂').s
      = e₂.toRingHom (D.mapHuber e₁ he₁ he₁').s)
    (hs₁₂ : (D.mapHuber (e₁.trans e₂) (he₂.comp he₁) (he₁'.comp he₂')).s
      = (e₁.trans e₂).toRingHom D.s) :
    (((D.mapHuber e₁ he₁ he₁').mapHuber e₂ he₂ he₂').coeRingHom).comp
...
theorem presheafValueRingEquivHuber_comp_apply
  ...
  refine presheafValue_eq_of_coeRingHom'
    ...
    (fun l => ?_) x
  have hs₁ : D₁.s = e₁.toRingHom D.s := rfl
  have hT₁ : ∀ t ∈ D.T, e₁.toRingHom t ∈ D₁.T := fun _ ht => Finset.mem_image_of_mem _ ht
  have hs₂ : D₁₂.s = e₂.toRingHom D₁.s := rfl
  have hT₂ : ∀ t ∈ D₁.T, e₂.toRingHom t ∈ D₁₂.T := fun _ ht => Finset.mem_image_of_mem _ ht
  have hs₁₂ : Dt.s = (e₁.trans e₂).toRingHom D.s := rfl
  have hT₁₂ : ∀ t ∈ D.T, (e₁.trans e₂).toRingHom t ∈ Dt.T :=
    fun _ ht => Finset.mem_image_of_mem _ ht
  have hL1 : presheafValueRingEquivHuber e₁ he₁ he₁' D (D.coeRingHom l)
      = D₁.coeRingHom (locMapOfHom e₁.toRingHom D D₁ hs₁ l) :=
    presheafValueMapOfHom_coe e₁.toRingHom he₁ D _ hs₁ hT₁ l
  have hL2 : presheafValueRingEquivHuber e₂ he₂ he₂' D₁
      (D₁.coeRingHom (locMapOfHom e₁.toRingHom D D₁ hs₁ l))
      = D₁₂.coeRingHom (locMapOfHom e₂.toRingHom D₁ D₁₂ hs₂
          (locMapOfHom e₁.toRingHom D D₁ hs₁ l)) :=
  ...
  have hR1 : presheafValueRingEquivHuber (e₁.trans e₂) (he₂.comp he₁)
      ...
      = Dt.coeRingHom (locMapOfHom (e₁.trans e₂).toRingHom D Dt hs₁₂ l) :=
    presheafValueMapOfHom_coe (e₁.trans e₂).toRingHom (he₂.comp he₁) D _
      hs₁₂ hT₁₂ l
  have hR2 : restrictionMapHom Dt D₁₂ hle
      (Dt.coeRingHom (locMapOfHom (e₁.trans e₂).toRingHom D Dt hs₁₂ l))
      = restrictionMapAlg Dt D₁₂ hle
          (locMapOfHom (e₁.trans e₂).toRingHom D Dt hs₁₂ l) := by
    letI : UniformSpace (Localization.Away Dt.s) := Dt.uniformSpace
    letI : IsTopologicalRing (Localization.Away Dt.s) := Dt.isTopologicalRing
    letI : IsUniformAddGroup (Localization.Away Dt.s) := Dt.isUniformAddGroup
    exact UniformSpace.Completion.extensionHom_coe
      (restrictionMapAlg _ _ hle) (restrictionMapAlg_continuous _ _ hle) _
  show presheafValueRingEquivHuber e₂ he₂ he₂' D₁
      (presheafValueRingEquivHuber e₁ he₁ he₁' D (D.coeRingHom l))
    = restrictionMapHom Dt D₁₂ hle
        (presheafValueRingEquivHuber (e₁.trans e₂) (he₂.comp he₁)
          (he₁'.comp he₂') D (D.coeRingHom l))
  rw [hL1, hL2, hR1, hR2]
  exact congr_fun (congrArg DFunLike.coe (locMapOfHom_comp_eq_restrictionMapAlg_comp
    e₁ he₁ he₁' e₂ he₂ he₂' D hle hs₁ hs₂ hs₁₂)) l
