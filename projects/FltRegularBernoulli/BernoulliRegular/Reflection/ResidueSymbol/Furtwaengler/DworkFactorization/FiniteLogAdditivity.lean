...
/-!
# Additivity of the finite logarithm

This file proves the finite-log additivity law for the product coordinate
`x + y + x*y`, by combining the formal logarithm identity with the localized
homogeneous coefficient evaluator.
-/
...
theorem coeff_subst_log_coe_eq_sum_Icc {A : Type*} [CommRing A] [Algebra ℚ A]
