...
theorem norm_oddBernoulliFactor_eq_one_of_not_dvd_num (hp_odd : p ≠ 2)
  ...
  have hbridge : (-(1 / 2 : ℚ_[p])) * BernoulliGen ((teichmullerCharQp p) ^ j) 1 =
    ...
    have ha' :
        ((a : ℤ_[p]) : ℚ_[p]) =
          (c : ℚ_[p]) *
            ((((bernoulli (j + 1) : ℚ) / ((j : ℕ) + 1 : ℚ)) : ℚ) : ℚ_[p]) := by
      rw [ha, ← hc]
      push_cast
      ring_nf
...
theorem norm_hMinus_eq_norm_irregularFactor :
  ...
  haveI : Fact (Nat.Prime 37) := ⟨by decide⟩
  set f : ℕ → ℚ_[37] := fun j ↦
    (-(1 / 2 : ℚ_[37])) * BernoulliGen ((teichmullerCharQp 37) ^ j) 1 with hf
  have hformula :
      ((hMinus K : ℕ) : ℚ_[37]) = (2 * 37 : ℚ_[37]) * ∏ j ∈ oddSet 36, f j := by
...
theorem teichmuller_sModEq_pow_val_pow_two (a : ZMod p) :
  ...
  rw [show (2 : ℕ) + 1 = 3 by rfl] at h_pow
...
theorem sum_val_pow_sModEq_const :
  ...
  simp_rw [hterm]
  rw [show (PadicInt.toZModPow 3 (31487 : ℤ_[37]) : ZMod (37 ^ 3)) =
      (31487 : ZMod (37 ^ 3)) by
    rw [show (31487 : ℤ_[37]) = ((31487 : ℕ) : ℤ_[37]) by norm_cast, map_natCast]
    norm_cast]
...
theorem thirtyseven_mul_bernoulliGen_eq_intSum :
    (37 : ℚ_[37]) * BernoulliGen ((teichmullerCharQp 37) ^ 31) 1 =
      ((∑ a : ZMod 37, ((teichmullerChar 37) ^ 31) a * (a.val : ℤ_[37]) : ℤ_[37]) :
        ℚ_[37]) := by
  haveI : Fact (Nat.Prime 37) := ⟨by decide⟩
  set ωZ : DirichletCharacter ℤ_[37] 37 := (teichmullerChar 37) ^ 31
  set ωQ : DirichletCharacter ℚ_[37] 37 := (teichmullerCharQp 37) ^ 31
  ...
  have hB :=
    natCast_mul_BernoulliGen_one_of_ne_one (R := ℚ_[37]) (N := 37) (χ := ωQ) hωQ_ne_one
...
theorem norm_thirtyseven_mul_bernoulliGen_sub_const_le :
  ...
  have hcoe_eq :
      (37 : ℚ_[37]) * BernoulliGen ((teichmullerCharQp 37) ^ 31) 1 -
          (31487 : ℚ_[37]) = (((S - (31487 : ℤ_[37])) : ℤ_[37]) : ℚ_[37]) := by
...
theorem norm_const_eq :
  ...
  have h1 : ‖((37 ^ 2 : ℕ) : ℚ_[37])‖ = (37 : ℝ) ^ (-2 : ℤ) := by
    rw [show ((37 ^ 2 : ℕ) : ℚ_[37]) = ((37 : ℕ) : ℚ_[37]) ^ 2 by
      push_cast
      ring]
...
omit [NumberField.IsCMField (CyclotomicField 37 ℚ)] in
private theorem norm_neg_half_eq_one : ‖(-(1 / 2 : ℚ_[37]))‖ = 1 := by
  rw [norm_neg]
  have htwo : ‖(2 : ℚ_[37])‖ = 1 := by
    have : ‖((2 : ℕ) : ℚ_[37])‖ = 1 :=
      (Padic.norm_natCast_eq_one_iff (p := 37) (n := 2)).2 (by decide)
    simpa using this
  rw [show (1 / 2 : ℚ_[37]) = (2 : ℚ_[37])⁻¹ by norm_num, norm_inv, htwo, inv_one]
...
`‖37·B - 31487‖ ≤ 37⁻³ < 37⁻² = ‖31487‖`, so ultrametricity gives
`‖37·B‖ = 37⁻²`; dividing by the `37`-unit `37·(-½)⁻¹` gives
`‖-½·B‖ = ‖37·B‖/37⁻¹·… = 37⁻¹ > 37⁻²`. -/
theorem flt37SharpHMinusValuation_proved : Flt37SharpHMinusValuation := by
  ...
  have hnormB :
      ‖BernoulliGen ((teichmullerCharQp 37) ^ 31) 1‖ = (37 : ℝ) ^ (-1 : ℤ) := by
    ...
    have hsplit :
        (37 : ℝ) ^ (-2 : ℤ) = (37 : ℝ) ^ (-1 : ℤ) * (37 : ℝ) ^ (-1 : ℤ) := by
      rw [← zpow_add₀ (by norm_num : (37 : ℝ) ≠ 0)]
      norm_num
    rw [hsplit] at hmul
    exact mul_left_cancel₀ h37ne hmul
  rw [norm_mul, norm_neg_half_eq_one, one_mul, hnormB]
  apply zpow_lt_zpow_right₀ (by norm_num : (1 : ℝ) < 37)
  norm_num
...
banked `kellner_at_zero_not_dvd` (`37² ∤ B₃₂.num`): if
`‖(B₃₂/32 : ℚ₃₇)‖ ≤ 37⁻²`, then multiplication by the `37`-unit
`B₃₂.den · 32` gives `‖(B₃₂.num : ℚ₃₇)‖ ≤ 37⁻²`,
i.e. `37² ∣ B₃₂.num`, contradiction. -/
theorem zpow_lt_norm_bernoulli_thirtytwo_ratio :
    (37 : ℝ) ^ (-2 : ℤ) <
  ...
  have hnum_eq : (((bernoulli 32 : ℚ) / 32 : ℚ) : ℚ_[37]) *
    ...
    have hQ : ((bernoulli 32 : ℚ) / 32) * (((bernoulli 32).den : ℚ) * 32) =
      ...
      have hbase :
          (bernoulli 32 : ℚ) * ((bernoulli 32).den : ℚ) = ((bernoulli 32).num : ℚ) := by
        have hnd := Rat.num_div_den (bernoulli 32)
        field_simp at hnd
        linarith [hnd]
      calc
        ((bernoulli 32 : ℚ) / 32) * (((bernoulli 32).den : ℚ) * 32)
    ...
    calc (((bernoulli 32 : ℚ) / 32 : ℚ) : ℚ_[37]) *
          ...
          = ((((bernoulli 32 : ℚ) / 32) * (((bernoulli 32).den : ℚ) * 32) : ℚ) :
              ℚ_[37]) := by
            push_cast
            ring
...
`zpow_lt_norm_bernoulli_thirtytwo_ratio` (`37⁻² < ‖B₃₂/32‖`) yields
...
theorem flt37SharpHMinusValuation_of_kummerCongruenceModSq
  ...
  have hfactor : ‖(-(1 / 2 : ℚ_[37])) * BernoulliGen ((teichmullerCharQp 37) ^ 31) 1‖ =
    ...
    rw [norm_mul, norm_neg_half_eq_one, one_mul]
  rw [hfactor]
  have hgt := zpow_lt_norm_bernoulli_thirtytwo_ratio
