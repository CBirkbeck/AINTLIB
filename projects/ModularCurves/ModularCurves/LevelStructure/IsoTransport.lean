...
pulling it back along the inverse. ForMathlib-bound: generic, no modular-curve content
(the extraction itself is a generalise-lane task). -/
...
along the inverse. ForMathlib-bound: generic, no modular-curve content. -/
...
ForMathlib-bound: generic, no modular-curve content. -/
