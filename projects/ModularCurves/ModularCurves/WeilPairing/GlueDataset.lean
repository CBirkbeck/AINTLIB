...
/-- **([KAPPA-DICT])** Over a `Pic`-trivial base, any skeleton representative of
`κ(Q)` carries the tensor-ideal dictionary: `M ⊗ I(D_Q) ≅ I(D_0)`. The class equation
`κ = [I(D_Q)]⁻¹ · [I(D_0)]` (the `picRelProj` correction dies over a trivial `Pic T`)
converts to a module isomorphism by `toSkeleton_eq_toSkeleton_iff`. -/
theorem exists_kappa_dict (hPicT : ∀ y : Scheme.Pic T, y = 1)
    (Q : (E.baseChange t).Point (𝟙 T)) (M : (pullback E.π t).Modules)
    (hM : letI := Scheme.Modules.monoidalCategory (pullback E.π t)
      (kappa E hsm t Q).val = toSkeleton M) :
    Nonempty (M.tensorObj (Scheme.Modules.idealModule
        (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).ideal) ≅
      Scheme.Modules.idealModule
        (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).ideal) := by
  letI := Scheme.Modules.monoidalCategory (pullback E.π t)
  letI := Scheme.Modules.symmetricCategory (pullback E.π t)
  haveI hsep : IsSeparated (pullback.snd E.π t) :=
    MorphismProperty.pullback_snd (P := @IsSeparated) E.π t ‹_›
  ...
  have hoQ := RelEffCartierDiv.sectionDivisor_isOfficial hsm' Q.1 Q.2
  have ho0 := RelEffCartierDiv.sectionDivisor_isOfficial hsm'
    (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
    (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)
  -- the correction dies over the trivial `Pic T`
  have hkx : kappa E hsm t Q =
      (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).picClass hoQ * ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).picClass ho0)⁻¹ := by
    show (Scheme.Modules.picRelProj E.π E.zero E.zero_π t
      ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).picClass hoQ * ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).picClass ho0)⁻¹)).1 = _
    show ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).picClass hoQ * ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).picClass ho0)⁻¹) *
      (Scheme.Pic.map (pullback.snd E.π t)
        (Scheme.Pic.map (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).picClass hoQ * ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).picClass ho0)⁻¹)))⁻¹ = _
    rw [hPicT (Scheme.Pic.map (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
      ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).picClass hoQ * ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).picClass ho0)⁻¹)), map_one, inv_one, mul_one]
  -- the class chase, read at skeleton level
  have hchase : toSkeleton (M.tensorObj (Scheme.Modules.idealModule (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).ideal)) =
      toSkeleton (Scheme.Modules.idealModule (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).ideal) := by
    have hu : kappa E hsm t Q *
        (show Scheme.Pic (pullback E.π t) from
          ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).isInvertible_idealModule hoQ).isUnit_toSkeleton.unit) =
        (show Scheme.Pic (pullback E.π t) from
          ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).isInvertible_idealModule ho0).isUnit_toSkeleton.unit) := by
      rw [hkx]
      show (((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).isInvertible_idealModule hoQ).isUnit_toSkeleton.unit⁻¹ *
        (((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).isInvertible_idealModule ho0).isUnit_toSkeleton.unit⁻¹)⁻¹) *
        ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).isInvertible_idealModule hoQ).isUnit_toSkeleton.unit =
        ((RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).isInvertible_idealModule ho0).isUnit_toSkeleton.unit
    ...
    rw [Units.val_mul, IsUnit.unit_spec, IsUnit.unit_spec] at hval
    calc toSkeleton (M.tensorObj (Scheme.Modules.idealModule (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).ideal))
        = toSkeleton (MonoidalCategoryStruct.tensorObj M
            (Scheme.Modules.idealModule (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).ideal)) :=
          CategoryTheory.toSkeleton_eq_toSkeleton_iff.mpr
            (Scheme.Modules.nonempty_tensorObj_iso_tensor _ _)
      _ = toSkeleton M * toSkeleton (Scheme.Modules.idealModule (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).ideal) :=
          Skeleton.toSkeleton_tensorObj _ _
      _ = (kappa E hsm t Q).val *
            toSkeleton (Scheme.Modules.idealModule (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t) Q.1 Q.2).ideal) := by rw [hM]
      _ = toSkeleton (Scheme.Modules.idealModule (RelEffCartierDiv.sectionDivisor (pullback.snd E.π t)
          (Scheme.Modules.baseChangeZero E.π E.zero E.zero_π t)
          (Scheme.Modules.baseChangeZero_snd E.π E.zero E.zero_π t)).ideal) := hval
  exact CategoryTheory.toSkeleton_eq_toSkeleton_iff.mp hchase
