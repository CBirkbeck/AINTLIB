...
lemma map_hom_eq_comap_inv (φ : X ≅ Y) (I : X.IdealSheafData) :
...
along the inverse. -/
lemma _root_.AlgebraicGeometry.Scheme.Hom.ker_comp_iso {T : Scheme.{u}} (z : T ⟶ X)
...
lemma _root_.AlgebraicGeometry.Scheme.Hom.ker_iso_comp {Z : Scheme.{u}} (τ : X ⟶ Y)
