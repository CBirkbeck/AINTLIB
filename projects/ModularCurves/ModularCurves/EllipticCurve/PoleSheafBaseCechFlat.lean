...
The pole line bundles on a smooth proper pointed curve admit finite affine
...
curve admits a finite affine trivializing cover whose base-linear Cech complex
is termwise flat. -/
